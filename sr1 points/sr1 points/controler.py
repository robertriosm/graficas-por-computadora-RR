...
from myrenderer import glCreateWindow, color, V2, drawPolygon
...
drawPolygon(pol1, render, color(1,0.5,0.5))
drawPolygon(pol2, render, color(0.5,1,0.5))
drawPolygon(pol3, render, color(0.5,0.5,1))
drawPolygon(pol4, render, color(1,1,1))
drawPolygon(pol5, render, color(1,1,1))
"""    

# create obj3d object
render.load_object('gatitoObj.obj',(50, 50),(10,10))

render.active_shader = frag

# write file
render.glFinish('gatito-de-poligonos.bmp')